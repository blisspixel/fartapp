...
| `CAP-001` | Capability reports keep eight decision axes distinct and non-collapsing | Exact localized-text and deterministic JSON Go fixtures | Ratify the assessment core and independent corpus in [CAPABILITY_REPORT.md](CAPABILITY_REPORT.md), then require cross-adapter conformance without treating missing capability as refusal |
